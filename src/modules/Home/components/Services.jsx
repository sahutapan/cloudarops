...
const Services = () => {
  return (
    <div className=" bg-[#001D39] ">
      <div className="grid grid-cols-1 md:grid-cols-2 px-10  gap-6 md:px-40  justify-center pt-12 pb-12">
        <div className="pt-6">
          <h2 className="text-3xl font-extrabold text-white mb-4">
            Our <span className="text-blue-500">services</span>
          </h2>
          <p className="text-lg text-white mb-8">
            From achieving production-grade readiness to ensuring 24/7 uptime,
            enhancing security, and optimizing your cloud costs, we tailor
        ...
        <div>
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-2">
            <div className="flex flex-col items-center p-6 border rounded-lg shadow-sm hover:shadow-lg">
